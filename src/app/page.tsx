          ...
          <div style={{ position: 'relative', zIndex: 1 }}>
            ...
            <div style={{ display: 'flex', gap: 16, justifyContent: 'center' }}>
              ...
              <Link href="/templates" style={{
                ...
                color: '#6B6B6B', fontSize: 16, fontWeight: 600, textDecoration: 'none',
              }}>
                浏览模板
              </Link>
            </div>
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: 20 }}>
        <div style={{ fontSize: 18, fontWeight: 600, marginBottom: 10, color: '#2D2D2D', lineHeight: 1.3 }}>
          {template.name}
        </div>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div style={{ fontSize: 26, fontWeight: 700, color: '#D4A574' }}>
            {price > 0 ? `￥${price}` : '免费'}
          </div>
