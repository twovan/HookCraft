...
const styles: Record<string, React.CSSProperties> = {
  container: { minHeight: "100vh", background: "linear-gradient(135deg, #FDFBF7 0%, #F5E6D3 100%)", display: "flex", alignItems: "center", justifyContent: "center", padding: "24px" },
  card: { background: "white", borderRadius: "24px", padding: "36px", maxWidth: "680px", width: "100%", boxShadow: "0 8px 40px rgba(212,165,116,0.15)" },
  header: { textAlign: "center" as const, marginBottom: "28px" },
  logo: { fontSize: "36px", fontWeight: 700, color: "#D4A574", fontFamily: "'Playfair Display', serif", margin: "0 0 6px" },
  subtitle: { fontSize: "15px", color: "#6B6B6B", margin: "0 0 8px" },
  ...
  uploadArea: { border: "2px dashed #E5E5E5", borderRadius: "14px", padding: "16px", textAlign: "center" as const },
  uploadBtn: { background: "none", border: "none", color: "#D4A574", fontSize: "14px", cursor: "pointer", fontWeight: 500, fontFamily: "'Inter', sans-serif" },
  fileInfo: { display: "flex", alignItems: "center", justifyContent: "center", gap: "12px", fontSize: "14px", color: "#2D2D2D" },
  clearBtn: { background: "none", border: "none", color: "#999", cursor: "pointer", fontSize: "16px" },
  hint: { fontSize: "12px", color: "#D4A574", marginTop: "6px", textAlign: "center" as const },
  modeToggle: { display: "flex", gap: "8px" },
  modeBtn: { flex: 1, padding: "10px", borderRadius: "12px", border: "1.5px solid #E5E5E5", background: "white", fontSize: "13px", cursor: "pointer", fontFamily: "'Inter', sans-serif", fontWeight: 500, color: "#6B6B6B", transition: "all 0.2s" },
  modeBtnActive: { borderColor: "#D4A574", background: "#FDF8F3", color: "#D4A574", fontWeight: 600 },
  presetGrid: { display: "flex", flexWrap: "wrap" as const, gap: "8px" },
  presetBtn: { padding: "7px 14px", borderRadius: "18px", border: "1.5px solid #E5E5E5", background: "white", fontSize: "13px", cursor: "pointer", color: "#2D2D2D", transition: "all 0.2s" },
  presetBtnActive: { borderColor: "#D4A574", background: "#FDF8F3", color: "#D4A574", fontWeight: 600 },
  textarea: { width: "100%", padding: "14px 16px", borderRadius: "14px", border: "1.5px solid #E5E5E5", fontSize: "14px", fontFamily: "'Inter', sans-serif", resize: "vertical" as const, marginBottom: "12px", outline: "none", boxSizing: "border-box" as const },
  generateBtn: { width: "100%", padding: "14px", borderRadius: "14px", border: "none", background: "linear-gradient(135deg, #D4A574, #C9A86A)", color: "white", fontSize: "15px", fontWeight: 600, cursor: "pointer", fontFamily: "'Inter', sans-serif" },
  ...
  waveBar: { width: "5px", height: "100%", background: "linear-gradient(180deg, #D4A574, #C9A86A)", borderRadius: "3px", animation: "wave 1.2s ease-in-out infinite" },
  loadingText: { fontSize: "13px", color: "#999" },
  errorBox: { background: "#FFF5F5", border: "1px solid #FED7D7", borderRadius: "12px", padding: "14px 16px", color: "#E53935", fontSize: "13px", marginBottom: "16px", whiteSpace: "pre-wrap" as const },
  lyricsBox: { background: "#FAFAF8", borderRadius: "14px", padding: "16px", marginBottom: "16px" },
  lyricsText: { fontSize: "13px", color: "#2D2D2D", lineHeight: 1.7, whiteSpace: "pre-wrap" as const, margin: 0, fontFamily: "'Inter', sans-serif" },
  tracksBox: { background: "#FAFAF8", borderRadius: "16px", padding: "20px" },
  tracksTitle: { fontSize: "16px", fontWeight: 600, color: "#2D2D2D", marginBottom: "16px", textAlign: "center" as const },
  trackItem: { background: "white", borderRadius: "12px", padding: "14px", marginBottom: "10px", border: "1px solid #f0f0f0" },
  trackHeader: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "10px" },
  trackName: { fontSize: "14px", fontWeight: 600, color: "#2D2D2D" },
  downloadBtn: { padding: "6px 14px", borderRadius: "10px", background: "linear-gradient(135deg, #D4A574, #C9A86A)", color: "white", textDecoration: "none", fontSize: "12px", fontWeight: 600 },
