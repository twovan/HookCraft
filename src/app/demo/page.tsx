...
const styles: Record<string, React.CSSProperties> = {
  ...
  modeBtn: { flex: 1, padding: "10px", borderRadius: "12px", border: "1.5px solid #E5E5E5", background: "#1a1a2e", fontSize: "13px", cursor: "pointer", fontFamily: "'PingFang SC', 'Microsoft YaHei', sans-serif", fontWeight: 500, color: "#9ca3af", transition: "all 0.2s" },
  ...
  presetBtn: { padding: "7px 14px", borderRadius: "18px", border: "1.5px solid #E5E5E5", background: "#1a1a2e", fontSize: "13px", cursor: "pointer", color: "#e8e8f0", transition: "all 0.2s" },
  presetBtnActive: { borderColor: "#7536d5", background: "rgba(117, 54, 213, 0.1)", color: "#7536d5", fontWeight: 600 },
  textarea: { width: "100%", padding: "14px 16px", borderRadius: "14px", border: "1.5px solid #E5E5E5", fontSize: "14px", fontFamily: "'PingFang SC', 'Microsoft YaHei', sans-serif", resize: "vertical" as const, marginBottom: "12px", outline: "none", boxSizing: "border-box" as const },
