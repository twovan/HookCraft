...
const TEXT = {
  ...
  retryApi: '\u91cd\u65b0\u53d1\u8d77\u4e91\u7aef\u5206\u6790',
  editorProject: '\u7f16\u8f91\u9879\u76ee',
  noCache: '\u6ca1\u6709\u53ef\u7528\u7684\u5206\u8f68\u7f13\u5b58\u3002\u786e\u8ba4\u989d\u5ea6\u5145\u8db3\u540e\uff0c\u53ef\u4ee5\u624b\u52a8\u91cd\u65b0\u53d1\u8d77\u4e91\u7aef\u5206\u6790\u3002',
  checkingCache: '\u68c0\u67e5\u7f13\u5b58',
  ...
  startingApiNow: '\u6b63\u5728\u542f\u52a8\u4e91\u7aef\u5206\u6790',
  apiAnalyzing: '\u4e91\u7aef\u5206\u6790\u4e2d',
  writingCacheNow: '\u6b63\u5728\u5199\u5165\u7f13\u5b58',
  preparingEditor: '\u51c6\u5907\u6b4c\u66f2\u7f16\u8f91',
  findingSavedStems: '\u6b63\u5728\u67e5\u627e\u5df2\u4fdd\u5b58\u7684\u5206\u8f68',
  readingCachedStems: '\u6b63\u5728\u8bfb\u53d6\u7f13\u5b58\u5206\u8f68',
  submittingStemService: '\u6b63\u5728\u63d0\u4ea4\u5206\u8f68\u8bf7\u6c42',
  stemServiceAnalyzing: '\u5206\u8f68\u670d\u52a1\u6b63\u5728\u5206\u6790\u97f3\u9891',
  savingAnalysis: '\u6b63\u5728\u4fdd\u5b58\u5206\u6790\u7ed3\u679c',
  cacheHit: '\u7f13\u5b58\u5df2\u547d\u4e2d',
  loadFailed: '\u5206\u8f68\u52a0\u8f7d\u5931\u8d25',
  checkingCacheDesc: '\u4f18\u5148\u8bfb\u53d6\u5df2\u4fdd\u5b58\u7684\u5206\u8f68\u7ed3\u679c\uff0c\u4e0d\u4f1a\u5148\u6d88\u8017\u65b0\u989d\u5ea6\u3002',
  readingCacheDesc: '\u6b63\u5728\u4ece\u5df2\u4fdd\u5b58\u8bb0\u5f55\u8bfb\u53d6\u5206\u8f68\u6587\u4ef6\uff1b\u5982\u679c\u7f13\u5b58\u7f3a\u5931\uff0c\u4f1a\u5c1d\u8bd5\u7528\u4efb\u52a1\u53f7\u8865\u8bfb\u4e00\u6b21\u3002',
  startingApiDesc: '\u6ca1\u6709\u53ef\u7528\u7f13\u5b58\u6216\u4f60\u624b\u52a8\u9009\u62e9\u91cd\u8bd5\uff0c\u6b63\u5728\u53d1\u8d77\u4e91\u7aef\u91cd\u65b0\u5206\u6790\u3002',
  apiProcessingDesc: '\u4e91\u7aef\u5df2\u63a5\u6536\u4efb\u52a1\uff0c\u6b63\u5728\u7b49\u5f85\u5206\u8f68\u5b8c\u6210\uff1b\u5b8c\u6210\u540e\u4f1a\u81ea\u52a8\u5199\u5165\u7f13\u5b58\u3002',
  hydratingCacheDesc: '\u5df2\u62ff\u5230\u5206\u8f68\u7ed3\u679c\uff0c\u6b63\u5728\u6574\u7406\u5e76\u8fdb\u5165\u6ce2\u5f62\u7f16\u8f91\u5668\u3002',
  cacheReadyDesc: '\u5df2\u4ece\u7f13\u5b58\u8bfb\u53d6\u5206\u8f68\uff0c\u4e0d\u4f1a\u4ea7\u751f\u65b0\u7684\u989d\u5ea6\u6d88\u8017\u3002',
  failedDesc: '\u5206\u8f68\u6ca1\u6709\u6210\u529f\u542f\u52a8\uff0c\u8bf7\u67e5\u770b\u9519\u8bef\u63d0\u793a\u540e\u91cd\u8bd5\u3002',
  cache: '\u7f13\u5b58',
  apiHydratedCache: '\u4e91\u7aef\u8865\u8bfb\u540e\u7f13\u5b58',
  apiRefilled: '\u4e91\u7aef\u56de\u586b',
  apiStateless: '\u4e91\u7aef\u4e34\u65f6\u7ed3\u679c',
  savedResult: '\u5df2\u4fdd\u5b58\u7ed3\u679c',
...
function formatPhaseTitle(phase: LoadingPhase) {
  ...
  if (phase === 'starting-api') return TEXT.submittingStemService;
  if (phase === 'api-processing') return TEXT.stemServiceAnalyzing;
