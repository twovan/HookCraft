...
const timelineSelectionActionsStyle: CSSProperties = {
  ...
  padding: '2px',
  borderRadius: 7,
  border: '1px solid rgba(83, 91, 124, 0.22)',
  background: 'rgba(9, 13, 23, 0.38)',
  boxShadow: 'none',
  whiteSpace: 'nowrap',
};
...
function timelineIconButtonStyle({
  ...
  return {
    ...
    borderRadius: 6,
    padding: 0,
    borderColor: active ? undefined : 'rgba(100, 113, 143, 0.18)',
    background: active ? undefined : 'rgba(13, 18, 29, 0.28)',
    color: disabled ? 'rgba(143, 153, 181, 0.42)' : active ? undefined : '#8f9ab2',
    cursor: disabled ? 'not-allowed' : 'pointer',
    boxShadow: active
      ? '0 0 0 1px rgba(190, 232, 95, 0.08) inset'
      : 'none',
...
function trackCollapseButtonStyle(active: boolean): CSSProperties {
  return {
    ...editorButtonChromeStyle({ tone: active ? 'info' : 'neutral', compact: true, round: false, active }),
    display: 'inline-flex',
    alignItems: 'center',
    justifyContent: 'center',
    width: 23,
    ...
    padding: 0,
    borderRadius: 6,
    borderColor: active ? 'rgba(122, 167, 255, 0.28)' : 'rgba(102, 114, 145, 0.18)',
    background: active ? 'rgba(64, 101, 158, 0.38)' : 'rgba(16, 22, 34, 0.24)',
...
const trackFxButtonStyle: CSSProperties = {
  ...
  gridRow: '2',
  justifySelf: 'start',
  ...editorButtonChromeStyle({ tone: 'neutral', compact: true, round: false }),
  minWidth: 48,
  minHeight: 20,
  padding: '0 6px',
  borderRadius: 6,
  borderColor: 'rgba(102, 114, 145, 0.18)',
  background: 'rgba(16, 22, 34, 0.24)',
  color: '#96a1b7',
  fontSize: 10,
  fontWeight: 760,
};
...
function trackMiniActionStyle(disabled: boolean): CSSProperties {
  return {
    ...editorButtonChromeStyle({ tone: 'neutral', compact: true, round: false, disabled }),
    minWidth: 54,
    minHeight: 20,
    padding: '0 6px',
    borderRadius: 6,
    borderColor: disabled ? 'rgba(48, 52, 76, 0.5)' : 'rgba(102, 114, 145, 0.18)',
    background: disabled ? 'rgba(20, 24, 34, 0.32)' : 'rgba(16, 22, 34, 0.24)',
    color: disabled ? '#62687c' : '#96a1b7',
    fontSize: 10,
    fontWeight: 760,
  };
}
...
function trackToggleStyle(active: boolean, tone: 'mute' | 'solo' | 'export' | 'retry' = 'export'): CSSProperties {
  ...
  return {
    ...
    minWidth: tone === 'export' ? 36 : 23,
    minHeight: 23,
    padding: tone === 'export' ? '0 6px' : '0 2px',
    borderColor: active ? undefined : 'rgba(102, 114, 145, 0.2)',
    background: active ? undefined : 'rgba(16, 22, 34, 0.28)',
    color: active ? undefined : '#9da8bc',
    borderRadius: 5,
    fontSize: 10,
    fontWeight: active ? 860 : 720,
    fontVariantNumeric: 'tabular-nums',
